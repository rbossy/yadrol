...
var _extractPositionalArgs = function(callArgs) {
    var posArgs = [];
...
var parseExpressions = function(sourceFile, input, recordLogger) {
    ...
    parser.yy.extractPositionalArgs = _extractPositionalArgs;
...
var _compareCounter = function(a, b) {
...
ListReorder.SORTED.reorder = function(list) { list.sort(compare); }; 
