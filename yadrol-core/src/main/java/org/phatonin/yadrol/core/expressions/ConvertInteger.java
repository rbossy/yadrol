...
public class ConvertInteger extends AbstractIntegerExpression {
	...
	public ConvertInteger(Location location, Expression expression) {
		super(location);
	...
	public AbstractIntegerExpression reduce() throws EvaluationException {
		...
		return new ConvertInteger(getLocation(), expression.reduce());
	}
	...
	public Expression substituteVariables(Scope scope) {
		return new ConvertInteger(getLocation(), expression.substituteVariables(scope));
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConvertInteger other = (ConvertInteger) obj;
		if (expression == null) {
