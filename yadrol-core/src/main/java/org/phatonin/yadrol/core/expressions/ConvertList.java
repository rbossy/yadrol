...
public class ConvertList extends AbstractListExpression {
	...
	public ConvertList(Location location, Expression expression) {
		super(location);
	...
	public AbstractListExpression reduce() throws EvaluationException {
		...
		return new ConvertList(getLocation(), expression.reduce());
	}
	...
	public Expression substituteVariables(Scope scope) {
		return new ConvertList(getLocation(), expression.substituteVariables(scope));
	}
