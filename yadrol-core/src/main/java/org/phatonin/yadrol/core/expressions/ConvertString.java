...
public class ConvertString extends AbstractStringExpression {
	...
	public ConvertString(Location location, Expression expression) {
		super(location);
	...
	public AbstractStringExpression reduce() throws EvaluationException {
		...
		return new ConvertString(getLocation(), expression.reduce());
	}
	...
	public Expression substituteVariables(Scope scope) {
		return new ConvertString(getLocation(), expression.substituteVariables(scope));
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConvertString other = (ConvertString) obj;
		if (expression == null) {
